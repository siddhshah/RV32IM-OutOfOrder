...
extern "C" {
#endif
void  rmaPropagate0_p_fifo_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate0_fifo_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate0_wn_fifo_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate1_p_fifo_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate1_fifo_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate1_wn_fifo_simv_daidir (UB  * pcode, scalar  val);
